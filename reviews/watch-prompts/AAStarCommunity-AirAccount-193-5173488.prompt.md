...
to review AAStarCommunity/AirAccount#193 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: docs(oob): 串口救板工具 serial-run.py + mx93b-serial-poweroff.sh
- url: https://github.com/AAStarCommunity/AirAccount/pull/193
- base: main
- head: docs/oob-serial-rescue
- head_oid: 5173488cce54f6029f38a8b30f03a7dae60a1a74
