...
to review AAStarCommunity/aastar-sdk#316 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: test(dvt): dvt3 independent-node on-chain registration evidence script (CC-17)
- url: https://github.com/AAStarCommunity/aastar-sdk/pull/316
- base: main
- head: test/dvt3-onchain-register-evidence
- head_oid: cfb40e4d1c490a4017ddd7b9bbeb1ef9a9b97433
