...
to review AAStarCommunity/Brood#16 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: docs(research): ANE (definition / rollout / org-model)
- url: https://github.com/AAStarCommunity/Brood/pull/16
- base: main
- head: docs/research-ane
- head_oid: 08a76dcddf8af5f2647357fe33ebd6c1bcac04d4
