...
to review AAStarCommunity/aastar-sdk#317 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: ci(gates): promote check:addresses + check:stubs to hard gates, kill the vacuous ABI pass (T3.1.1)
- url: https://github.com/AAStarCommunity/aastar-sdk/pull/317
- base: main
- head: chore/ci-sync-gates
- head_oid: 846e4f493f40c573649726036361fec7cd69aa6c
