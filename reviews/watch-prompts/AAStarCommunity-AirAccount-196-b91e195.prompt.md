...
to review AAStarCommunity/AirAccount#196 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: feat(updater): 发版签名工具 release-sign.sh + minisign 公钥入库
- url: https://github.com/AAStarCommunity/AirAccount/pull/196
- base: main
- head: feat/updater-release-signing
- head_oid: b91e19507cf67721c7bc9e24c3d9dcf1a00dd8e2
