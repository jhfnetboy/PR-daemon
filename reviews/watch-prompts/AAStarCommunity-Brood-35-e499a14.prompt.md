...
to review AAStarCommunity/Brood#35 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: feat(pilot): run 改为无人值守交付循环 + 文档齐全门禁 + 默认设 /goal (v1.1.0)
- url: https://github.com/AAStarCommunity/Brood/pull/35
- base: main
- head: feat/pilot-unattended-delivery-loop
- head_oid: e499a146e47cc1338c418b7674b0522e00e7cbf8
