...
to review AAStarCommunity/Brood#34 in PR-Daemon autonomous watch mode.
...
PR metadata:
- title: docs(pilot): scan-focus 指标改为主干最后提交 + marketplace 描述纠偏 (v1.0.3)
- url: https://github.com/AAStarCommunity/Brood/pull/34
- base: main
- head: fix/pilot-scan-metric-docs
- head_oid: 24da4fc1e24dd74183177f0e34e000e4033e76c9
