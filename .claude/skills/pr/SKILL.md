...
[ ] Step 6.6: **无论 APPROVE 还是 REQUEST_CHANGES 都要发**（6.6.2，无例外）。ListAgents 找原仓库会话 → 命中 1 个才发；发了要带回信地址+回信要求+「不要合并」；**命中 0 个必须在 Step 8 汇报里写明「无在跑会话 —— 未投递」**
```
